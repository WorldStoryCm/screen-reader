    ...
    <div ref={ref} style={style} className="w-64 bg-neutral-800 border border-neutral-600 rounded-lg shadow-xl">
      {loading ? (
        ...
        <div className="p-3 space-y-2">
          ...
          {card.note && (
            <p className="text-[16px] text-neutral-500 italic">{card.note}</p>
          )}
            ...
            {LEVELS.map((lv) => {
              ...
              return (
                <button
                  ...
                  className={`flex-1 py-1 text-[16px] font-medium rounded transition-colors ${
          ...
          <p className="text-[16px] text-neutral-600 text-center">
        ...
        <div className="p-3 space-y-2">
          ...
          <div className="flex gap-1.5">
            ...
            <button
              ...
              className="px-2 py-1 text-[16px] bg-blue-600 hover:bg-blue-500 rounded transition-colors"
            >
              + Create Card
            </button>
          </div>
